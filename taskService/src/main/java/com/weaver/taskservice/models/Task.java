package com.weaver.taskservice.models;
...
public class Task {
	...
	public Task( String title, String description, double creditValue, String createdBy, String assignedBy,
			String assignedTo, long initiallyDueAt, long maxDueAt, long currentlyDueAt, long completedAt, long createdAt,
			 long updatedAt) {
		super();
